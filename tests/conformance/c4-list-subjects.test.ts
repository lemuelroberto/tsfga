...
import { setupBatch, teardownBatch, uuid } from "./c4-batch/setup.ts";
import { fgaListUsers, renderSubject } from "./c4-batch/upstream.ts";

/**
 * `listSubjects` against ListUsers, pushed at the seams round 1
 * left alone.
 *
 * `a4-list-subjects.test.ts` establishes the bound: tsfga reports
