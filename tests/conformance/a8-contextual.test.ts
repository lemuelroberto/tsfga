...
describe("Contextual Tuple Conformance", () => {
  ...
  beforeAll(async () => {
    ...
    storeId = await fgaCreateStore("a8-contextual-conformance");
    modelId = await fgaWriteModel(storeId, "./a8-contextual/model.dsl");
  ...
  test("the relation configs say what the model says", () => {
    expectConfigsMatchModel("./a8-contextual/model.dsl", fixture, {
      coverage: "complete",
    });
  });
});
