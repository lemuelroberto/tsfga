...
describe("listObjects condition parity", () => {
  ...
  beforeAll(async () => {
    ...
    storeId = await fgaCreateStore("a4-cond-conformance");
    authorizationModelId = await fgaWriteModel(storeId, "./a4-cond/model.dsl");
  ...
  test("the relation configs say what the model says", () => {
    expectConfigsMatchModel("./a4-cond/model.dsl", fixture, {
      coverage: "complete",
    });
  });
});
