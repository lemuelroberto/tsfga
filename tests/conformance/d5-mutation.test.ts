...
/**
 * Round 4, agent D5: write/read interleaving.
 *
...
describe("D5 write/read interleaving", () => {
  ...
  beforeAll(async () => {
    ...
    storeId = await fgaCreateStore("d5-mutation");
    authorizationModelId = await fgaWriteModel(
      storeId,
      "./d5-mutation/model.dsl",
    );
  ...
  test("the relation configs say what the model says", () => {
    expectConfigsMatchModel("./d5-mutation/model.dsl", fixture, {
      coverage: "complete",
    });
  });
});
