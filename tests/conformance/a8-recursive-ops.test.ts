...
describe("Recursive Loop Conformance", () => {
  ...
  beforeAll(async () => {
    ...
    storeId = await fgaCreateStore("a8-recursive-ops-conformance");
    modelId = await fgaWriteModel(storeId, "./a8-recursive-ops/model.dsl");
  ...
  test("the relation configs say what the model says", () => {
    expectConfigsMatchModel("./a8-recursive-ops/model.dsl", fixture, {
      coverage: "complete",
    });
  });
});
