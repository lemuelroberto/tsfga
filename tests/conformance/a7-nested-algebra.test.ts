...
describe("Nested DSL algebra conformance", () => {
  ...
  beforeAll(async () => {
    ...
    storeId = await fgaCreateStore("a7-nested-algebra");
    authorizationModelId = await fgaWriteModel(
      storeId,
      "./a7-nested-algebra/model.dsl",
    );
    await fgaWriteTuples(
      storeId,
      "./a7-nested-algebra/tuples.yaml",
  ...
  test("the relation configs say what the model says", () => {
    expectConfigsMatchModel("./a7-nested-algebra/model.dsl", fixture, {
      coverage: "complete",
      tsfgaOnlyHelpers: [
        "doc_a7.h_c_and_a",
        "doc_a7.h_a_or_b",
