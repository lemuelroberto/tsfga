...
describe("A5 condition drift against its restriction (upstream corpus)", () => {
  ...
  test("the relation configs say what the model says", () => {
    expectConfigsMatchModel("./a5-condition-drift/model.dsl", fixture, {
      coverage: "complete",
    });
  });
});
