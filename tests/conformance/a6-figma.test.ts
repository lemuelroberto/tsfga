...
describe("Figma Model Conformance", () => {
  ...
  beforeAll(async () => {
    ...
    storeId = await fgaCreateStore("a6-figma");
    authorizationModelId = await fgaWriteModel(storeId, "./a6-figma/model.dsl");
    await fgaWriteTuples(
      storeId,
      "./a6-figma/tuples.yaml",
      authorizationModelId,
      uuidMap,
    );
  });
  ...
  test("the relation configs say what the model says", () => {
    expectConfigsMatchModel("./a6-figma/model.dsl", fixture, {
      coverage: "complete",
