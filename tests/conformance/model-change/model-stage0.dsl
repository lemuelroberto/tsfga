...
type uop_document_a5
  relations
    define viewer: [uop_group1_a5#member, uop_group2_a5#member]
...
type top_document_a5
  relations
    define parent: [top_group_a5, top_group_a5:*]

type tdi_role_a5
  relations
    define assignee: [user_a5, tdi_role_a5#assignee]
...
type udi_role_a5
  relations
    ...
    define assignee: [user_a5, udi_role_a5#placeholder]
...
type udw_job_a5
  relations
    define can_read: [udw_role_a5#assignee, user_a5:*]
