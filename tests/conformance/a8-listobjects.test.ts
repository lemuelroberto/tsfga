...
describe("ListObjects Depth Conformance", () => {
  ...
  beforeAll(async () => {
    ...
    storeId = await fgaCreateStore("a8-listobjects-conformance");
    modelId = await fgaWriteModel(storeId, "./a8-listobjects/model.dsl");
  ...
  test("the relation configs say what the model says", () => {
    expectConfigsMatchModel("./a8-listobjects/model.dsl", fixture, {
      coverage: "complete",
    });
  });
});
