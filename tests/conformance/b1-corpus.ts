 ...
 * OpenFGA alongside other agents' fixtures.
 *
 ...
 *
 * That behaviour is worth knowing, and `b1-condition-spread`
 ...
 *
 * The `group` is the fourth UUID field, allocated per agent in
 * `tmp/openfga-parity/ISSUES.md`, so two fixtures running
 * concurrently against one database cannot mint the same id.
 */
export function ids(
