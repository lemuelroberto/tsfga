...
describe("Data Residency Model Conformance", () => {
  ...
  beforeAll(async () => {
    ...
    // === Tuples (mirroring ./d4-residency/tuples.yaml) ===
  ...
  test("the relation configs say what the model says", () => {
    expectConfigsMatchModel("./d4-residency/model.dsl", fixture, {
      coverage: "complete",
    });
  });
});
