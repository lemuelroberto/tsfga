...
describe("Wide Fanout Conformance", () => {
  ...
  beforeAll(async () => {
    ...
    storeId = await fgaCreateStore("a8-fanout-conformance");
    modelId = await fgaWriteModel(storeId, "./a8-fanout/model.dsl");
  ...
  test("the relation configs say what the model says", () => {
    expectConfigsMatchModel("./a8-fanout/model.dsl", fixture, {
      coverage: "complete",
    });
  });
});
