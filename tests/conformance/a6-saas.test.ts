...
describe("Multi-tenant SaaS Model Conformance", () => {
  ...
  beforeAll(async () => {
    ...
    storeId = await fgaCreateStore("a6-saas");
    authorizationModelId = await fgaWriteModel(storeId, "./a6-saas/model.dsl");
  ...
  test("the relation configs say what the model says", () => {
    expectConfigsMatchModel("./a6-saas/model.dsl", fixture, {
      coverage: "complete",
    });
  });
});
