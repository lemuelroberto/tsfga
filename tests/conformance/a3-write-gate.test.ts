...
describe("Write Gate Conformance", () => {
  ...
  beforeAll(async () => {
    ...
    storeId = await fgaCreateStore("a3-write-gate-conformance");
    authorizationModelId = await fgaWriteModel(
      storeId,
      "./a3-write-gate/model.dsl",
    );
  });
  ...
  describe("wildcards", () => {
    ...
    test("GAP-040: a wildcard subject carrying a subject relation", async () => {
  ...
  describe("conditions", () => {
    ...
    test("GAP-041: a condition context over the byte limit", async () => {
    ...
    test("GAP-042: a control character in a context value", async () => {
  ...
  describe("duplicate writes", () => {
    test("GAP-043: rewriting an existing tuple", async () => {
    ...
    test("GAP-044: rewriting a tuple with a different condition", async () => {
      const row: AddTupleRequest = {
        objectType: "doc_a3",
        objectId: objectId(),
        relation: "both",
  ...
  test("the relation configs say what the model says", () => {
    expectConfigsMatchModel("./a3-write-gate/model.dsl", fixture, {
      coverage: "complete",
    });
  });
});
