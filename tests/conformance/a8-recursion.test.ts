...
describe("Recursion Depth Conformance", () => {
  ...
  beforeAll(async () => {
    ...
    storeId = await fgaCreateStore("a8-recursion-conformance");
    modelId = await fgaWriteModel(storeId, "./a8-recursion/model.dsl");
  ...
  test("the relation configs say what the model says", () => {
    expectConfigsMatchModel("./a8-recursion/model.dsl", fixture, {
      coverage: "complete",
    });
  });
});
